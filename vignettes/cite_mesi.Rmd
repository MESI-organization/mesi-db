...
Once it's ready to be included (Latex-readable), it can be placed in a Latex document (`latex/example.tex`) using `\include{latex/table_clean}` in the tex source.
